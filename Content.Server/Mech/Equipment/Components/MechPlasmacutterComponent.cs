...
/// </summary>
[RegisterComponent]
public sealed partial class MechPlasmacutterComponent : Component
{
    /// <summary>
    /// The change in energy after each shot.
    /// </summary>
    [DataField("shotEnergyDelta")]
    public float ShotEnergyDelta = -30;

    /// <summary>
    /// How long does it take to use something?
    /// </summary>
    [DataField("useDelay")]
